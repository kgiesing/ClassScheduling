...
{
public:
    ScheduleWriter(string filename, string delimiter = " | ") :
        FileWriter(filename) , _delimiter(delimiter) { };
...
private:
    ...
    Schedule *_contents;
    void printCourseLine(ostream& f, const string&, const string&, const string&,
